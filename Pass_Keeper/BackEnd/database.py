...
# db = Database("D:\\DataManager\\Pass_Keeper\\Data\\users_database3.db")
# print(db.is_tables_valid())
# v, m = db.is_database_valid()
# print("\n".join(m))
# for data_id in [1592,1593, 1594, 1595]:
#     print(db.get_specific_row(data_id, 1))
# for row in db.fetch_rows_one_by_one("users_data"):
#     print(row)
    # print(row['site'], row['username'], row['password'], row['extra_info'])

# print(db.count_users_data())
# sites = ['https://nobat.epolice.ir\n', 'wallex.ir\n', 'https://www.mycloudwallet.com/\n']
# for site in sites:
#     r, msg = db.get_duplicate_column(1,'site', site)
#     print(r)
# while True:
#     i = 1016
#     r, msg = db.remove_user_data(i)
#     i+=1
#     if not r:
#         print("removed: ", i, msg)
#         break
# r, msg = db.get_specific_row(4,1)
# print(r,msg)
# query = "UPDATE users SET password = ? WHERE user_id = ?"
# hashed = hashlib.sha256('qwe321'.encode()).hexdigest()
# params = (hashed,1)
# print(db.get_column_values("users_data", "site", 1))
# _, message = db.execute_query(query, params)
# print("message: ", message)
# if "successfully" in message.lower():
#     # Update last_modified
#     query, params = db.qf.update_last_modified(1)
#     _, update_message = db.execute_query(query, params)
#     print("update message: ", update_message)
#     if "successfully" in update_message.lower():
#         print("Data updated and user updated successfully")
